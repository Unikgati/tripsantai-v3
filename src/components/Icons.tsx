...
export const WhatsAppIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38c1.45.79 3.08 1.21 4.79 1.21 5.46 0 9.91-4.45 9.91-9.91S17.5 2 12.04 2zM12.04 20.15c-1.48 0-2.91-.4-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31c-.82-1.31-1.26-2.83-1.26-4.38 0-4.54 3.69-8.23 8.24-8.23 4.54 0 8.23 3.69 8.23 8.23 0 4.54-3.69 8.23-8.23 8.23zm4.26-6.17c-.23-.12-1.36-.67-1.57-.75s-.36-.12-.52.12c-.15.23-.59.75-.73.9s-.27.18-.5.06c-.23-.12-1-.37-1.9-1.17-.71-.62-1.18-1.38-1.32-1.62s-.14-.37.06-.5c.18-.17.37-.45.56-.6s.12-.27.18-.45c.06-.18 0-.34-.06-.45s-.52-1.24-.71-1.7c-.19-.46-.39-.39-.52-.4s-.27-.03-.42-.03c-.15 0-.39.06-.59.3s-.79.77-.79,1.87c0,1.1.81,2.17.93,2.32s1.59,2.44,3.86,3.43c.54.23.97.37,1.3.48.52.17.98.15,1.35.09.43-.07,1.36-.56,1.55-1.1s.19-.99.13-1.1c-.06-.12-.23-.18-.48-.3z"></path>
    </svg>
);
...
export const BedIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V3"/><path d="M2 9h20"/><path d="M12 14v-5"/></svg>
);
export const UtensilsIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2a5 5 0 0 0-5 5v15"/></svg>
);
...
export const TicketIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 9a3 3 0 0 1 3-3h14a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V9Z"/><path d="M9 11v5"/><path d="M15 11v5"/></svg>
);
...
export const SailboatIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 18H2a2 2 0 0 1 0-4h20a2 2 0 0 1 0 4Z"/><path d="M21 14L12 2 3 14"/><path d="M12 2v12"/></svg>
);
...
export const UploadCloudIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.2 15c.7-1.2 1-2.5.7-3.9-.6-2.4-3-4-5.4-4-1.8-1.8-4.5-2.5-7.3-1.8-3.5.8-5.9 3.8-5.9 7.4 0 4.2 3.3 7.6 7.4 7.6h7.4c2.2 0 4-1.8 4-4 0-1.5-.8-2.8-2-3.6z"/><path d="M16 16.5l-4-4-4 4"/><path d="M12 12.5v9"/></svg>
);
...
export const InvoiceIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M21 19l-2 2-2-2"></path>
    </svg>
);

// Simpler, more minimal invoice/link icon used on admin list (smaller visual weight)
export const InvoiceLinkIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 8V7a2 2 0 0 0-2-2h-6"></path>
        <path d="M3 16v1a2 2 0 0 0 2 2h6"></path>
        <rect x="7" y="5" width="10" height="14" rx="2" ry="2"></rect>
        <path d="M9 9h6"></path>
    </svg>
);